        ...
        <div class="flex s_b_b">
          ...
          <div class="weui-cell size15 max_w">
            ...
            <div class="weui-cell__bd">
              <img class="online-plan-avatar" src="/static/images/u169.png" alt="avatar">
      ...
      mockData: [
        {
          ...
          workInfo: [
            { v: '作业类型', value: '上线计划', read: true, no_arrow: true },
            { v: '是否天窗', value: '是', read: true, no_arrow: true  },
            { v: '工作类型', value: '跟车作业', read: true, no_arrow: true  },
            { v: '工作路局', value: '武汉', read: true, no_arrow: true },
            { v: '工作地点', value: '京广高铁工务段信阳东站', read: true, no_arrow: true },
            { v: '详细位置', value: '站南5公里', read: true, no_arrow: true },
