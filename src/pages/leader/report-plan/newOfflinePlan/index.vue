<template>
  <div style="height:100vh;">
    <div style="height:100vh;" v-if="!isMsgShow">
      <span class="group-title">新建次日计划（非上线作业）</span>
...
export default {
  ...
  data () {
    return {
      ...
      msgParamsObj: {
        title: '计划提交成功',
        descList: ['编号为EO1809231814196051的次日计划提交成功。'],
        btnList: [
          {text: '重新编辑', link: ''},
          {text: '新计划', link: '', action: function () {
            wx.showActionSheet({itemList: ['上线计划', '非上线计划'], success (res) {
