<template>
  <div class="color_f6 w_h100">
    ...
    >
      <div>计划列表</div>
      <div @click="paramsObj1.isPanelShow=true">全部计划</div>
    </div>
    <div class="mt10">
      ...
      list: [
        {
          ...
          status_color: "red",
          plan_color: "#199ed8",
          link: "/pages/leader/report_tomorrow/on_plan_details/main"
        },
        {
          title: "01月12日计划",
          type: "走访",
        ...
        },
        {
          ...
          plan_color: "#008000",
          hide_border: true,
          link: "/pages/leader/report_tomorrow/off_plan_details/main"
        }
      ],
      button_list: [
        {
    ...
    show_picker() {
      mpvue.showActionSheet({
        ...
        success: function({ tapIndex }) {
          if (tapIndex === 0) {
            mpvue.navigateTo({
              url: "/pages/leader/report_tomorrow/on_plan/main"
            });
          } else if (tapIndex === 1) {
            mpvue.navigateTo({
