  ...
  <div class="color_f6 w_h100 size14 page_box pb100">
    ...
    <div v-if="step==1">
      ...
      <div class="p10_15 bg_white flex">
        ...
        <div class="max_w" @click="sele_location">{{work_location}}</div>
      </div>
    ...
    <!-- <cover-view v-if="step!=3" class="fx_b w_90 cover_btn">
      <button>下一步</button>
    </cover-view> -->
...
export default {
  ...
  onShow() {
    if (wx.getStorageSync("sele_work_location")) {
      this.work_location = wx.getStorageSync("sele_work_location");
      console.log(wx.getStorageSync("sele_work_location"));
    }
  },
  mounted() {},
  methods: {
    ...
    get_textarea_val(res) {
      this.edit_textarea.value1 = res;
    },
    get_textarea_val1(res) {
      this.edit_textarea1.placeholder = res;
      this.edit_textarea1.value1 = res;

      console.log(res);
    },
    get_textarea_val2(res) {
      this.edit_textarea2.placeholder = res;
      this.edit_textarea2.value1 = res;
    ...
    sele_location() {
      this.go_page("/pages/leader/report_today/sele_location/main");
    }
  },
  onHide() {
    wx.removeStorageSync("sele_work_location");
  },
  onUnload() {
    Object.assign(this.$data, this.$options.data());
    wx.removeStorageSync("sele_work_location");
