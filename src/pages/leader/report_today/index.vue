      ...
      list: [
        {
          ...
          status_color: "red",
          plan_color: "#199ed8",
          link: "/pages/leader/report-reports/reportDetails/main?id=1"
        },
        {
          title: "01月12日计划",
          type: "走访",
  ...
  methods: {
    ...
    onConfirm(e) {
      ...
      if (e.value[1] == "on") {
        //上线
        this.go_page(
          "/pages/leader/report_today/online_report/main?sele_type=" +
            (e.value[0] == "old" ? 1 : 0) +
            "&sele_idx=" +
            e.value[2]
        );
        ...
        //非上线
        this.go_page(
          "/pages/leader/report_today/offline_report/main?sele_type=" +
            (e.value[0] == "old" ? 1 : 0) +
            "&sele_idx=" +
            e.value[2]
        );
