      ...
      list: [
        {
          ...
          link:
            "/pages/worker/device_menagement/status_menagement_list/start_service/main"
        },
        {
          title: "2019-01-05",
          type: "结束维修",
          time: "2019-11-12 11:01:01",
          link:
            "/pages/worker/device_menagement/status_menagement_list/end_service/main"
        },
        {
          title: "2019-01-05",
          type: "报废",
      ...
      mpvue.showActionSheet({
        ...
        success: function({ tapIndex }) {
          if (tapIndex === 0) {
            ...
            mpvue.navigateTo({
              url: "/pages/worker/device_menagement/status_menagement_list/edit_state/main"
            });
          }
        }
      });
