<template>
  <div class="bg_gray">
    ...
    <div style="margin-bottom:150px;">
      ...
      <div style="font-size:15px;background:#fff;">
    ...
    <div style="position:fixed; bottom:10px; width:90%; left:0; right:0; margin:0 auto;">
      ...
      <button class="weui-btn weui-btn_primary" @click="goWorkBench">返回工作台</button>
    </div>
    <!-- alert begin -->
    <div v-if="isAlertShow" style="height:100vh;width:100%;position:absolute;top:0;left:0;">
      <div class="weui-mask" style="height:100vh"></div>
      <div class="weui-dialog dialog-position" style="position:absolute;top:50%;left:50%;">
        ...
        <div class="weui-dialog__ft">
          ...
          <a class="weui-dialog__btn weui-dialog__btn_primary" @click="goWorkBench">确定</a>
        </div>
      </div>
    </div>
  </div>
...
export default {
      ...
      mockData: [
        ...
        },
        {
          ...
          detailInfo: {
            operationTitle: '作业详情',
            operationInfo: [
              {v: '车轮测量个数', value: '544', read: true, no_arrow: true, hide_border: true},
            ] ,
            otherTitle: '其他',
            otherInfo: [
              {v: '是否夜间', value: '否', read: true, no_arrow: true, hide_border: true},
              {v: '夜间时长', value: '4.5', read: true, no_arrow: true, hide_border: true},
              {v: '徒步距离', value: '15公里', read: true, no_arrow: true, hide_border: true},
              {v: '是否高原作业', value: '否', read: true, no_arrow: true, hide_border: true},
              {v: '备注', value: '备注信息', read: true, no_arrow: true, hide_border: true},
            ]
          },
          timeInfo: [
            {v: '创建时间', value: '2019-01-12 09:23:12', read: true, no_arrow: true },
        ...
        },
        {
          ...
          detailInfo: {
            operationTitle: '作业详情',
            operationInfo: [
              {v: '曲线测量个数', value: '23', read: true, no_arrow: true, hide_border: true},
              {v: '曲线测量点数量', value: '43', read: true, no_arrow: true, hide_border: true},
              {v: '直线测量个数', value: '33', read: true, no_arrow: true, hide_border: true},
              {v: '直线测量点个数', value: '12', read: true, no_arrow: true, hide_border: true},
            ] ,
            otherTitle: '其他',
            otherInfo: [
              {v: '是否夜间', value: '否', read: true, no_arrow: true, hide_border: true},
  ...
  methods: {
    ...
    goTo (url) {
      if (Number(this.reportData.id) < 4) {
        wx.redirectTo({url})
      } else {
    ...
    goWorkBench () {
      console.log(123)
      wx.switchTab({url: '/pages/work_bench_item/main'})
    }
  },
}
</script>
