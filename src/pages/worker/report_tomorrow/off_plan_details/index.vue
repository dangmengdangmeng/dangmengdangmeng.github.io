...
export default {
  ...
  data() {
    return {
      ...
      edit_input1: [
        { v: "编号", value: "EO1809231814196051" },
        { v: "计划日期", value: "2019-01-01", hide_border: true  },
      ],
      edit_input2: [
        { v: "作业类型", value: "非上线计划" },
        { v: "工作类型", value: "跟车作业" },
        { v: "工作路局", value: "武汉" },
        { v: "工作地点", value: "京广高铁工务段信阳东站" },
        {
          v: "备注",
          value: "京广高铁工务段信阳东站",
          hide_border: true
      ...
      edit_input4: [
        { v: "创建时间", value: "2019-01-12 16:47:22" },
        {
          v: "最后更新",
  ...
  methods: {
    button_cb() {
      wx.redirectTo({
        url: "/pages/worker/report_tomorrow/off_plan/main"
      });
    },
    go_page(url) {
