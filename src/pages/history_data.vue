<template>
  <div class="cur_page_box size14 color_6 m_center pt20">
    <div class="top_tit_box mb20">
      <div class="size24">门店实销数据</div>
    ...
    <div class="nav_bar_box">
      <el-tabs v-model="nav_bar_val">
        <el-tab-pane label="日交易数据" name="day"></el-tab-pane>
        <el-tab-pane label="月交易数据" name="mouth"></el-tab-pane>
      </el-tabs>
    </div>
