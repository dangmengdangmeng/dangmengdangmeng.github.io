...
import { sendSignalling } from '../../utils/sign.js';

const TestSortId = 'TestSortId';
/* 只有直播才有的信令 */
export const LiveRoomSignalling: any = {
  /**
   * 直播端点名相关信令
   */
  sendSignallingFromLiveCallRoll(isDelMsg: boolean, data: any, serial: string) {
  ...
  /* 学生签到信令 */
  sendSignallingToStudentSingin(isDelMsg: boolean, toId: string, signalId: string, data: any) {
  ...
  /* 改变抽奖人数信令 */
  sendSignallingToLiveLuckDrawConfig(data: any) {
    const sendSignalData = {
   ...
   */
  sendSignallingToLiveLuckDraw(isDelMsg: boolean, signalId: string, data: any, isSave = true) {
    const sendSignalData = {
      name: 'LiveLuckDraw',
      signalId,
      isDelMsg,
  ...
  /* 发送抽奖结果信令 */
  sendSignallingToLiveLuckDrawResult(isDelMsg: boolean, signalId: string, data: any) {
    const sendSignalData = {
  ...
  /* 送花信令 */
  sendSignallingToSendGifts(data: any) {
  ...
  /* 发送发布投票信令 */
  sendSignallingToVoteStart(isDelMsg: boolean, signalId: string, data: any, type: string) {
    const sendSignalData = {
      name: 'VoteStart',
      signalId,
      data,
  ...
  /* 发送提交投票信令 */
  sendSignallingToVoteCommit(signalId: string, toId: string, actions: any, associatedMsgID: string) {
    const sendSignalData = {
      name: 'voteCommit',
      signalId,
      toId,
  ...
  /* 发送获取当前投票结果信令 */
  sendSignallingToVoteResult(signalId: string, toId: string, associatedMsgID: string) {
    const sendSignalData = {
      name: 'VoteResult',
      signalId,
      toId,
  ...
  /* 发送投票记录列表信令 */
  sendSignallingToVoteRecordList(data: any) {
    const sendSignalData = {
      name: 'VoteRecordList',
  ...
  /* 发送投票结果信令 */
  sendSignallingToPublicVoteResult(data: any) {
    const sendSignalData = {
  ...
  /* 发送通知信令 */
  sendSignallingToNoticeInform(data: any) {
    const sendSignalData = {
  ...
  /* 发送公告信令 */
  sendSignallingToNoticeBoard(data: any) {
    const sendSignalData = {
   ...
   * */
  sendSignallingShowmineSubsort(id: string) {
    const sendSignalData = {
   ...
   * data:{min:1, max:maxSort}, //数据，min:表示排序最小值，默认为1，max：表示排序最大值，默认为发起排序器时的maxSort【max不能超过maxSort，当maxSort为-1时，max为当前排序器列表总数】
   * */
  sendSignallingShowmineCancelsubsort(id: string) {
    const sendSignalData = {
   ...
   * */
  sendSignallingAllowUpperwheat(data: any, toId: string) {
    const sendSignalData = {
   ...
   * */
  sendSignallingApplyShowmine(id: string, modify: 0 | 1, actions: any, userId: string) {
    const sendSignalData = {
      name: 'UpperwheatSortCommit',
      signalId: id,
      toId: '__none',
  ...
  */
  sendSignallingToLiveQuestions(isDelMsg: boolean, signalId: string, data: any) {
    const sendSignalData = {
      name: 'LiveQuestions',
      signalId,
      data,
  ...
  sendSignallingContest() {
    const sendSignalData = {
      ...
      isSave: true,
      type: 'useSort',
      data: { maxSort: 300, subInterval: 1000 },
    };
    sendSignalling(sendSignalData);
  },
  // 老师结束抢答排序
  sendSignallingDelContest() {
    const sendSignalData = {
      name: 'Contest_v1',
      signalId: 'Contest',
      toId: '__all',
  ...
  // 订阅排序器
  sendSignallingContestSubsort() {
    const sendSignalData = {
      name: 'ContestSubsort_v1',
      signalId: 'ContestSubsort',
      toId: '__none',
      isSave: true,
      type: 'subSort',
      associatedMsgID: 'Contest',
      data: { min: 1, max: 300 },
    };
    sendSignalling(sendSignalData);
  },
  // 删除订阅器
  sendSignallingCancelContestSubsort() {
    const sendSignalData = {
      name: 'ContestSubsort_v1',
      signalId: 'ContestSubsort',
      toId: '__none',
  ...
  // 学生抢答排序器
  sendSignallingContestCommit(id: string, modify: 0 | 1, actions: any, userId: string) {
    const sendSignalData = {
      name: 'ContestCommit_v1',
      signalId: 'ContestCommit',
      toId: '__none',
      isSave: false,
      type: 'sort',
      modify,
