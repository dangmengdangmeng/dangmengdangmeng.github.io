...
const initialState = {
  ...
  countDown: {
    countDownState: '', // init-初始化， timing-计时中，pause-暂停中，  timerend-计时结束
    countDownData: {
      sendTimeUserId: '', // 发起计时器的人的id
      totalTime: 300, // 计时总时间
      defaultTime: 300, // 计时默认时间
    },
  },
...
export default function reducer(state = initialState, action) {
  ...
  switch (type) {
    ...
    case SET_ANSWERDATA:
      ...
      break;
    case SET_CHATSTATUS:
      newState.chat.chatState = payload;
      break;
    case SET_CHATDATA:
      if (Object.getOwnPropertyNames(payload).length === 0) {
        newState.chat.chatData = {};
        break;
      }
      newState.chat.chatData = {
        ...newState.chat.chatData,
      ...
      break;
    case SET_COUNTDOWNSTATUS:
      newState.countDown.countDownState = payload;
      break;
    case SET_COUNTDOWNDATA:
      newState.countDown.countDownData = {
        ...newState.countDown.countDownData,
        ...payload,
      };
      break;
    ...
    case INIT_MODULES_STATE:
      return initialState;
    case SET_RESPONSER_STATUS:
      return {
        ...state,
        responserStatus: payload,
      };
    case SET_CONTEST_STUDENT:
      return {
        ...state,
        contestStudentList: payload,
      };
    default:
      break;
  }
