    ...
    return (
      <div className="answer">
        ...
        <div className="answer-container">
          ...
          {['answer', 'stoped'].includes(answerState) &&
            (currPanel === 'statistical' ? (
              <AnswerStatistical personCount={totalUsers} options={JSON.stringify(selecteds)} />
            ) : (
              <AnswerDetail page={detailPageInfo.current} details={JSON.stringify(detailData)} />
            ))}
        ...
        <div className="answer-footer">
          ...
          {fromID === this.user.id && [0, 1].includes(this.user.role) && answerState === 'answer' && currPanel !== 'detail' && (
          ...
          {fromID === this.user.id && [0, 1].includes(this.user.role) && answerState === 'stoped' && (
