    ...
    return [0, 1].includes(this.user.role) ? (
      <div id={id} className="call-roll">
        <div className="panel-title">
          ...
          <Icon type="close" onClick={this.closeCallRoll.bind(this)} />
        </div>
          ...
          {callRollState === 'call' && (
            <div>
              ...
              <select name="" id="" onChange={this.onChangeTime.bind(this)}>
                <option className="oneSlect" value="0">
                  {lang.timerType0}
                </option>
...
export default connect(mapStateToProps, mapDispatchToProps)(CallRoll);
