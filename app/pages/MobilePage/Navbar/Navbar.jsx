...
class NavbarMobile extends React.Component {
  ...
  componentDidMount() {
    Event.on('recv-chat-msg', this.handleRoomTextMessage.bind(this), this.listernerBackupid);
  ...
  render() {
    ...
    const { isMp4AllFull, isClassBegin, roomInfo } = this.props;
