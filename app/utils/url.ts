import { ServcieInfo } from "@app/global/types/Global";
...
export function getServiceInfo(): ServcieInfo {
  ...
  return {
    ...
    host,
    port,
    webRequest: host.includes('demo') || host.includes('release') ? `${protocol}://${host}:${port}` : 'https://api.roadofcloud.net:443',
    aliUrl,
  };
};
