...
const englishLanguage: any = {
  ...
  raisehand: {
    full: 'The stage is full',
    nobody: 'The number of people on stage is full',
    langTap: 'Raise your hand and press long',
  },
  chat: {
    errorNotice: {
      getMediaErrorBefore: '',
    ...
    chatInput: {
      ...
      serverShutdown: 'Server shutdown room',
      mine: 'I',
      dui: 'to',
      you: 'you',
      said: 'said',
      ...
      useDevicetype: 'Client device currently in use',
  ...
  video: {
    ...
    pressedHome: `App is switched to backstage`,
    noCamera: 'No Camera',
    noMac: 'No Mic',
    publishESCFall: 'Browser not support view',
    subscribeESCFall: 'Browser does not support initiation，please replace',
    noCameraType: {
      '1': 'unknown error',
      2: 'Device not found',
      3: 'Camera disable',
      4: 'Camera occupied',
      5: 'device open error code 5',
      6: 'device open error code 6',
      7: 'device open error code 7',
      8: 'device open error code 8',
      9: 'Invalid browser, please replace',
    },
    noMicType: {
      1: 'unknown error',
      2: 'Device not found',
    ...
    videoLoading: 'Data loading',
    switchOne2oneVideoLayout: 'Video Switch',
    audioPlayErr1: 'no audio, click',
    audioPlayErrReload: '“reload”',
    audioPlayErr2: 'to try',
  },
  whiteboard: {
    reload: 'reload',
    reloading: 'loading',
  ...
  courseList: {
    ...
    fileFilterInner: {
      cantOpenMsg: 'not support this file when desktop share.',
      fileTime: 'Time',
      fileType: 'Type',
      fileName: 'Name',
      fileAdd: 'Add',
    ...
    serviceInner: {
      ...
      exceed: `${roleTexts.courseware} size or number of pages too large！`,
      ...
      fileSizeLimit: 'File size exceeded limit',
    },
  },
  toolsBoxInner: {
    titleInfo: 'Notice',
    ...
    customAnn: 'After submission, all users are visible.',
    ...
    contest: 'Contest',
    answerSpeak: 'Answer speak',
    InAnswering: 'In answering',
    contestSpeak: 'Get',
    getChance: 'Get chance',
    noAnswer: 'No answer',
    waiting: 'wait..',
  },
  deviceTest: {
    detectionAudioInner: {
      ...
      hear:
        'Hi, this is your test assistant. I’m here to help you test your audio and video devices so that you can have a better experience. Can you hear me now?',
    ...
    microphoneInner: {
      ...
      microphon: 'Please talk into the microphone, see if there is any fluctuation in the volume bar below, the fluctuation means the microphone is normal!',
      warm: "Warm Tips: If you can't hear the music, please check it in the following way:",
      warm1: '1. If anti-virus software (such as 360 Guard, Baidu Guard) pops up prompt information, please click "Allow"',
      warm2: '2. Confirm that the microphone and speaker are connected and turned on',
      warm3: '3.Make sure that the volume of microphone and loudspeaker has been adjusted to sufficiently high.',
    ...
    resultsInner: {
      ...
      set: 'set',
      zc_result:
        'Congratulations! You’ve passed the test. All your devices are working fine. Now you can choose “Enter Room” and try the online audio and video interaction.',
      yc_result:
        'Wow, something is wrong with the device!Please adjust and check the equipment against the test report, otherwise it may affect the use experience.',
    },
    videoInner: {
  ...
  liveMobilePage: {
    ...
    automedialineTip: 'Network poor, find better lines',
    poorNetworkForMe: 'Poor network . Switch WiFi / 4G or reset router',
  ...
  userListInner: {
    start: 'start ',
    stop: 'stop ',
    shuffling: 'Video robin',
    shufflingNum: 'The number of round robin',
    shufflingTime: 'Round robin time',
    shufflingConfirm: 'confirm',
    peopleText: ' people',
    minutes: ' minutes',
    seconds: ' seconds',
    roster: 'Name list',
    studentCount: 'student nums',
    searchPlacehoder: 'Please enter the search content',
    removeStudent: {
    ...
    remoteControl: {
      ...
      signaling: 'switch signaling lines',
      media: 'switch media lines',
      courseware: 'switch courseware lines',
      refreshCourseware: `refresh ${roleTexts.courseware}`,
  ...
  welcomDete: {
    ...
    ensure1: 'for better effect',
    ensure2: 'please complete equipment testing first.',
  ...
  serviceText: {
    roomListner: {
      ...
      roomEndNotice_NoMinutes: `It's time to finish class.`,
      roomEndNotice_MinutesBefore: `It's time to finish class.Room will be closed in `,
      roomEndNotice_MinutesAfter: ` minutes`,
    },
    roomservice: {
